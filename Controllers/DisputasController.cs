    ...
    public class DisputasController : Controller
    {
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaHabilidades = "http://alitor.somee.com/RpgApi/PersonagemHabilidades/GetHabilidades";
        ...
        public async Task<ActionResult> DisputaGeralAsync()
        {
            try
            {
                ...
                string uriBuscaPersonagens = "http://alitor.somee.com/RpgApi/Personagens/GetAll";
                ...
                string uriDisputa = "http://alitor.somee.com/RpgApi/Disputas/DisputaEmGrupo";
